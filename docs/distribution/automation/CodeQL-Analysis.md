...
- **Supported Languages**: C++, C#, Go, Java, JavaScript/TypeScript, Python, Ruby, Swift, and GitHub Actions (workflow files and composite action metadata, analyzed without a build).
